...
import BannerAggregated from "../sections/banner/v1/BannerAggregated";
...
const HomeV6Aggregated = () => {
  ...
  return (
    <Layout pageTitle="Make America Ghibli Again - Multi-Chain Presale">
      <Header variant="v5" />
      <BannerAggregated />
...
export default HomeV6Aggregated;