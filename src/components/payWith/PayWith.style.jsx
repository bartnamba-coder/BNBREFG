...
const PayWithStyleWrapper = styled.div`
  ...
  .presale-item-notification {
    margin-top: 25px; /* Increased from 15px to 25px (added 10px) */
    text-align: center;
    
    p {
      font-size: 19px; /* 25% bigger than original 14px */
      font-weight: 500;
      color: ${({ theme }) => theme.colors.white};
      padding: 10px 18px;
  ...
  ${({ variant }) =>
    ...
    css`
      ...
      .presale-item-btn {
        border-radius: 10px;
        background: linear-gradient(90deg, #d51a1a 0%, #eb2525 100%);
        backdrop-filter: blur(10px);
        color: #ffffff;

        &:hover {
          background: linear-gradient(90deg, #ffbe20 0%, #f5ae00 100%);
        }
      }
    `}
