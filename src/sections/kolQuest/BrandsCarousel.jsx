...
import BrandsCarouselWrapper from "./BrandsCarousel.style";
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="brands-carousel-header">
              <h3 className="carousel-title">Our Trusted Partners</h3>
              <p className="carousel-subtitle">
                Join the growing network of Kols supporting the $BNBMAGA movement
              </p>
            </div>
