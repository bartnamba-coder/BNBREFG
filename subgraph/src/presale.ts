...
import {
  ReferralPurchase,
  ReferralWithdrawn
} from "../generated/PresaleEthereum/Presale"
...
export function handleReferralPurchase(event: ReferralPurchase): void {
  handleReferralPurchaseCommon(event, "ETH")
}

export function handleReferralWithdrawn(event: ReferralWithdrawn): void {
  handleReferralWithdrawnCommon(event, "ETH")
}

// BSC handlers
export function handleReferralPurchaseBSC(event: ReferralPurchase): void {
  handleReferralPurchaseCommon(event, "BNB")
}

export function handleReferralWithdrawnBSC(event: ReferralWithdrawn): void {
  handleReferralWithdrawnCommon(event, "BNB")
}

// Common referral purchase handler
function handleReferralPurchaseCommon(event: ReferralPurchase, chain: string): void {
...
function handleReferralWithdrawnCommon(event: ReferralWithdrawn, chain: string): void {
